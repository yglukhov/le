////////////////////////////////////////////////////////////////////////////////
//  le					DOCTYPE: public c/c++ header, doxygen source.
//
/// @file core/config/slPrefix.h
/// Common project settings definitions.
/// Defines most common macros, such as #LE_FLAG_DEBUG.
//
//  Copyright (c) 2009 by  S.O.K.I.R.A. labs.
////////////////////////////////////////////////////////////////////////////////
