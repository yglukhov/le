...
template <typename T, template <typename T1, typename T2> class TPredicate>
struct _TSTypeListSortJ<_TSTypeListNode<T, _SNullType>, TPredicate>
{
	typedef _TSTypeListNode<T, _SNullType> _result;
};

template <template <typename T1, typename T2> class TPredicate>
struct _TSTypeListSortJ<_SNullType, TPredicate>
{
	typedef _SNullType _result;
};

template <typename Head, typename Tail, template <typename T1, typename T2> class TPredicate>
struct _TSTypeListSortJ<_TSTypeListNode<Head, Tail>, TPredicate>
{
	typedef Head in1;
	typedef typename _TSTypeListTypeAt<Tail, 0>::_result in2;

	typedef typename TSSelect<TPredicate<in1, in2>::result == 1, in1, in2>::result out1;
	typedef typename TSSelect<TPredicate<in1, in2>::result != 1, in1, in2>::result out2;

	typedef _TSTypeListNode<out1, typename _TSTypeListSortJ<_TSTypeListNode<out2, typename _TSTypeListPopFront<Tail>::_result>, TPredicate>::_result> _result;
};

template <unsigned start, unsigned end, class TList, template <typename T1, typename T2> class TPredicate>
struct _TSTypeListSortIterate
{
	typedef typename _TSTypeListSortJ<typename _TSTypeListSortIterate<start + 1, end, TList, TPredicate>::_result, TPredicate>::_result _result;
};

template <unsigned end, class TList, template <typename T1, typename T2> class TPredicate>
struct _TSTypeListSortIterate<end, end, TList, TPredicate>
{
	typedef typename _TSTypeListSortJ<TList, TPredicate>::_result _result;
};

template <class TListNode, template <typename T1, typename T2> class TPredicate>
struct _TSTypeListSort
{
	typedef typename _TSTypeListSortIterate<0, _TSTypeListLength<TListNode>::_result,
		TListNode, TPredicate>::_result _result;
};
